...
(function () {
  ...
  <div id="videoTogetherHeader" class="vt-modal-content">
    ...
    <div class="vt-modal-header">
      <img class="vt-logo-circle" style="width: 16px; height: 16px;"
        src="https://www.2gether.video/icon/favicon-16x16.png">
      <div class="vt-modal-title">Video Together</div>
    </div>
    <div class="vt-modal-body">
      <span style="display: inline; height: 22px" id="videoTogetherRoleText"></span>
      <span style="display: inline; height: 22px" id="videoTogetherStatusText"></span>
...
<div style="width: 24px; height: 24px;" id="VideoTogetherSamllIcon">
  <img class="vt-logo-circle" draggable="false" width="24px" height="24px" id="videoTogetherMaximize"
...
<style>
  ...
  #videoTogetherFlyPannel {
    ...
    text-align: center;
    border-radius: 5.6px;
    box-shadow: 0 3px 6px -4px #fff, 0 6px 16px #00000014, 0 9px 28px 8px #0000000d;
  }
  ...
  #videoTogetherRoomPasswordInput:focus {
    border: 1px solid #63ADE5;
  }
  #videoTogetherRoomPasswordInput:hover {
    border: 1px solid #63ADE5;
  }
  ...
  #videoTogetherRoomNameInput:hover {
    border: 1px solid #63ADE5;
  }
	
 #videoTogetherHelpButton:hover {
    border-color: #63ADE5;
...
@media(prefers-color-scheme:dark) {
  ...
  #videoTogetherFlyPannel {
    ...
    text-align: center;
    border-radius: 5.6px;
    box-shadow: 0 3px 6px -4px #2b2b2b, 0 6px 16px #00000014, 0 9px 28px 8px #0000000d;
  }
