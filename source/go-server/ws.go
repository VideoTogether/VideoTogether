...
func (c *Client) readPump() {
	...
	for {
		...
		switch req.Method {
		case "timestamp":
			c.send <- ClientReplyMessage{
				Method: method,
				Data: float64(time.Now().UnixMilli()) / 1000,,
			}
		case "statistics":
		case "getRoom":
		case "updateRoom":
...
func composeMessage(method string, data interface{}) ([]byte, error)  {
	return json.Marshal(ClientReplyMessage{
		Method: method,
		Data: data,
	})
}
