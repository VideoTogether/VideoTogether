...
(function () {
    ...
    <div id="videoTogetherHeader">
        ...
        <button onclick='document.getElementById("videoTogetherFlyPannel").style.display="none"' style="margin-right: 20px;margin-left: auto;">-</button>
    </div>
...
<div id="VideoTogetherSamllIcon">
    <button onclick='document.getElementById("videoTogetherFlyPannel").style.display="block"'>[]</button>
</div>
