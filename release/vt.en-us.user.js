  ...
  #videoTogetherRoomPasswordInput {
    ...
    margin: 0 !important;
        ...
        JoinVoiceRoom() {
            ...
            alert("Voice Call is experimental now");
    ...
    class VideoTogetherExtension {
        ...
        setRole(role) {
            ...
            switch (role) {
                case this.RoleEnum.Master:
                    document.querySelector("#videoTogetherRoleText").innerHTML = "Host";
                    break;
                case this.RoleEnum.Member:
                    document.querySelector("#videoTogetherRoleText").innerHTML = "Member";
                    break;
                default:
        ...
        async SyncMemberVideo(data, videoDom) {
            ...
            this.sendMessageToTop(MessageType.UpdateStatusText, { text: "Sync " + this.GetDisplayTimeText(), color: "green" })
        }
